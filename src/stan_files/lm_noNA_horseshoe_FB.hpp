...
namespace model_lm_noNA_horseshoe_FB_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lm_noNA_horseshoe_FB");
    reader.add_event(49, 47, "end", "model_lm_noNA_horseshoe_FB");
    return reader;
}

#include <meta_header.hpp>
 class model_lm_noNA_horseshoe_FB : public prob_grad {
private:
    int N_train;
    int p;
    ...
    matrix_d X_test;
public:
    model_lm_noNA_horseshoe_FB(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lm_noNA_horseshoe_FB_namespace::model_lm_noNA_horseshoe_FB";
        ...
        try {
            ...
            validate_non_negative_index("tau_unif", "p", p);
            num_params_r__ += p;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("tau_unif", "p", p);
        context__.validate_dims("initialization", "tau_unif", "vector_d", context__.to_vec(p));
        vector_d tau_unif(static_cast<Eigen::VectorXd::Index>(p));
        for (int j1__ = 0U; j1__ < p; ++j1__)
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                tau_unif = in__.vector_lub_constrain(0,(stan::math::pi() / 2),p,lp__);
            else
                tau_unif = in__.vector_lub_constrain(0,(stan::math::pi() / 2),p);
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  tau(static_cast<Eigen::VectorXd::Index>(p));
            ...
            stan::math::assign(tau, multiply(lambda,stan::math::tan(tau_unif)));
            ...
            for (int j = 1; j <= p; ++j) {
                ...
                stan::model::assign(beta, 
                            ...
                            (get_base1(tau,j,"tau",1) * get_base1(beta_raw,j,"beta_raw",1)), 
            ...
            lp_accum__.add(cauchy_log<propto__>(lambda, 0, sigma));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_lm_noNA_horseshoe_FB_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double mu = in__.scalar_constrain();
        double sigma2 = in__.scalar_lb_constrain(0);
        vector_d beta_raw = in__.vector_constrain(p);
        vector_d tau_unif = in__.vector_lub_constrain(0,(stan::math::pi() / 2),p);
    ...
    static std::string model_name() {
        return "model_lm_noNA_horseshoe_FB";
    }
...
typedef model_lm_noNA_horseshoe_FB_namespace::model_lm_noNA_horseshoe_FB stan_model;

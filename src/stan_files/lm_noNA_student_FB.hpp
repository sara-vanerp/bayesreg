...
namespace model_lm_noNA_student_FB_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lm_noNA_student_FB");
    reader.add_event(46, 44, "end", "model_lm_noNA_student_FB");
    return reader;
}

#include <meta_header.hpp>
 class model_lm_noNA_student_FB : public prob_grad {
private:
    int N_train;
    int p;
    ...
    matrix_d X_test;
public:
    model_lm_noNA_student_FB(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lm_noNA_student_FB_namespace::model_lm_noNA_student_FB";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("prec")))
            throw std::runtime_error("variable prec missing");
        vals_r__ = context__.vals_r("prec");
        pos__ = 0U;
        context__.validate_dims("initialization", "prec", "double", context__.to_vec());
        double prec(0);
        prec = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,prec);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable prec: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            local_scalar_t__ prec;
            (void) prec;  // dummy to suppress unused var warning
            if (jacobian__)
                prec = in__.scalar_lb_constrain(0,lp__);
            else
                prec = in__.scalar_lb_constrain(0);
            ...
            stan::math::assign(beta, multiply((stan::math::sqrt((sigma2 / lambda)) * pow(prec,0.5)),beta_raw));
            ...
            lp_accum__.add(gamma_log<propto__>(prec, 0.5, 0.5));
    ...
    static std::string model_name() {
        return "model_lm_noNA_student_FB";
    }
...
typedef model_lm_noNA_student_FB_namespace::model_lm_noNA_student_FB stan_model;

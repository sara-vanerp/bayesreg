...
namespace model_lm_noNA_lasso_FB_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lm_noNA_lasso_FB");
    reader.add_event(41, 39, "end", "model_lm_noNA_lasso_FB");
    return reader;
}

#include <meta_header.hpp>
 class model_lm_noNA_lasso_FB : public prob_grad {
private:
    int N_train;
    int p;
    ...
    matrix_d X_test;
public:
    model_lm_noNA_lasso_FB(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lm_noNA_lasso_FB_namespace::model_lm_noNA_lasso_FB";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(double_exponential_log<propto__>(beta, 0, (sigma / lambda)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_lm_noNA_lasso_FB_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lm_noNA_lasso_FB_namespace::model_lm_noNA_lasso_FB stan_model;

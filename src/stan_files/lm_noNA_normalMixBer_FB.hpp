...
namespace model_lm_noNA_normalMixBer_FB_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lm_noNA_normalMixBer_FB");
    reader.add_event(46, 44, "end", "model_lm_noNA_normalMixBer_FB");
    return reader;
}

#include <meta_header.hpp>
 class model_lm_noNA_normalMixBer_FB : public prob_grad {
private:
    int N_train;
    int p;
    ...
    matrix_d X_test;
public:
    model_lm_noNA_normalMixBer_FB(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lm_noNA_normalMixBer_FB_namespace::model_lm_noNA_normalMixBer_FB";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= p; ++j) {
                ...
                lp_accum__.add(log_sum_exp((bernoulli_log(0,0.5) + normal_log(get_base1(beta,j,"beta",1),0,stan::math::sqrt(0.001))),(bernoulli_log(1,0.5) + normal_log(get_base1(beta,j,"beta",1),0,stan::math::sqrt(get_base1(tau2,j,"tau2",1))))));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_lm_noNA_normalMixBer_FB_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_lm_noNA_normalMixBer_FB";
    }
...
typedef model_lm_noNA_normalMixBer_FB_namespace::model_lm_noNA_normalMixBer_FB stan_model;

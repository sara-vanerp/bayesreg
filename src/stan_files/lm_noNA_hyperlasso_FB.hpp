...
namespace model_lm_noNA_hyperlasso_FB_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lm_noNA_hyperlasso_FB");
    reader.add_event(53, 51, "end", "model_lm_noNA_hyperlasso_FB");
    return reader;
}

#include <meta_header.hpp>
 class model_lm_noNA_hyperlasso_FB : public prob_grad {
private:
    int N_train;
    int p;
    ...
    double df;
public:
    model_lm_noNA_hyperlasso_FB(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lm_noNA_hyperlasso_FB_namespace::model_lm_noNA_hyperlasso_FB";
        ...
        try {
            ...
            validate_non_negative_index("phi2", "p", p);
            num_params_r__ += p;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("phi2")))
            throw std::runtime_error("variable phi2 missing");
        vals_r__ = context__.vals_r("phi2");
        pos__ = 0U;
        validate_non_negative_index("phi2", "p", p);
        context__.validate_dims("initialization", "phi2", "vector_d", context__.to_vec(p));
        vector_d phi2(static_cast<Eigen::VectorXd::Index>(p));
        for (int j1__ = 0U; j1__ < p; ++j1__)
            phi2(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_lb_unconstrain(0,phi2);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable phi2: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  phi2;
            (void) phi2;  // dummy to suppress unused var warning
            if (jacobian__)
                phi2 = in__.vector_lb_constrain(0,p,lp__);
            else
                phi2 = in__.vector_lb_constrain(0,p);
            ...
            for (int j = 1; j <= p; ++j) {
                ...
                stan::model::assign(beta, 
                            ...
                            (stan::math::sqrt(get_base1(phi2,j,"phi2",1)) * get_base1(beta_raw,j,"beta_raw",1)), 
                            "assigning variable beta");
            }
            current_statement_begin__ = 29;
            stan::math::assign(lambda2, (lambda * lambda));
            ...
            if (stan::math::is_uninitialized(lambda2)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: lambda2";
                throw std::runtime_error(msg__.str());
            }
            ...
            lp_accum__.add(exponential_log<propto__>(phi2, tau));
            current_statement_begin__ = 37;
            lp_accum__.add(gamma_log<propto__>(tau, df, (1 / lambda2)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_lm_noNA_hyperlasso_FB_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        vector_d phi2 = in__.vector_lb_constrain(0,p);
    ...
    static std::string model_name() {
        return "model_lm_noNA_hyperlasso_FB";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= p; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "phi2" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
...
typedef model_lm_noNA_hyperlasso_FB_namespace::model_lm_noNA_hyperlasso_FB stan_model;
